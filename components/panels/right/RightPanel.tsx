...
const Render3DPanel = () => {
    ...
    const [settings, setSettings] = useState({
      geometry: {
        edgeMode: 'medium', // soft, medium, sharp
                          ...
                          <div className="animate-fade-in">
                             ...
                             <div className="mb-4">
                                ...
                                <div className="h-4 w-full relative">
                                   ...
                                   {/* Thumb */}
                                   <div 
                                      className="absolute top-[-2px] bottom-[-2px] w-3 bg-white border border-border shadow-md rounded-full z-10 pointer-events-none transition-all duration-75"
                                      style={{ left: `calc(${((settings.lighting.sun.colorTemp - 2000) / 10000) * 100}% - 6px)` }}
                                   />
